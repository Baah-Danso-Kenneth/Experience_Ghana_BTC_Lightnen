...
function Header() {
  ...
  return (
    <div className="relative z-50 bg-[#000] text-white ">
        ...
        <div className="w-[30%] flex items-center justify-center gap-20">
          <div className="w-[30%] flex items-center">
              <Link  href="/" className='absolute '>
                 <Image src="/images/bitoga.png" className=' h-44 scale-125 object-contain' alt="app-img" width={100} height={100}/>
              </Link>
          </div>
          ...
          <div
            ...
            className={clsx(
              'w-[70%] flex items-center p-2 rounded-2xl cursor-pointer transition-all',
